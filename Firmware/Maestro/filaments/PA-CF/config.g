...
M207 S4 R0 F6000 T1500 Z0.2
 ; S3		3mm			positive length to retract, in mm
 ; R0		0mm			positive or negative additional length to un-retract, in mm
 ; F4500	100mm/sec		retraction feedrate, in mm/min
